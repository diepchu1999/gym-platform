...
final class StaffSqlPaths {
    ...
    static final String GET_STAFF_BY_USER_ACCOUNT_ID = "sql/staff/get_staff_by_user_account_id.sql";
    ...
    static final String LINK_USER_ACCOUNT = "sql/staff/link_user_account.sql";
